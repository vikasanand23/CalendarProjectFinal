angular.module("ui.rCalendar.tpls", ["view/calendar1/calendar.html", "view/calendar1/week.html", "view/calendar1/month.html"]);
angular.module('ui.rCalendar', ['ui.rCalendar.tpls'])
    ...
    .directive('calendar', function() {
        ...
        return {
            restrict: 'EA',
            replace: true,
            templateUrl: 'view/calendar1/calendar.html',
            scope: {
                calendarMode: '=',
                rangeChanged: '&',
                eventSelected: '&',
    ...
    .directive('monthview', ['dateFilter', function(dateFilter) {
        ...
        return {
            restrict: 'EA',
            replace: true,
            templateUrl: 'view/calendar1/month.html',
            require: ['^calendar', '?^ngModel'],
            link: function(scope, element, attrs, ctrls) {
                var ctrl = ctrls[0],
                    ngModelCtrl = ctrls[1];
    ...
    .directive('weekview', ['dateFilter', '$timeout', function(dateFilter, $timeout) {
        ...
        return {
            restrict: 'EA',
            replace: true,
            templateUrl: 'view/calendar1/week.html',
            require: '^calendar',
...
angular.module("view/calendar1/calendar.html", []).run(["$templateCache", function($templateCache) {
    $templateCache.put("view/calendar1/calendar.html",
        "<div ng-switch=\"calendarMode\">\n" +
        "    <div class=\"row calendar-navbar headingTags\">\n" +
        ...
        "            <button type=\"button\" class=\"btn btn-default btn-sm\" ng-click=\"move(1)\">Next<i\n" +
...
angular.module("view/calendar1/month.html", []).run(["$templateCache", function($templateCache) {
    $templateCache.put("view/calendar1/month.html",
        "<div>\n" +
        ...
        "                    <td ng-if=\"!event.allDay\" class=\"monthview-eventdetail-timecolumn\">Event Starts:  {{event.startTime|date: 'dd MMMM, yyyy, HH:mm'}}\n" +
        "                        Event Ends: {{event.endTime|date: 'dd MMMM, yyyy, HH:mm'}}\n" +
        "                    </td>\n" +
...
angular.module("view/calendar1/week.html", []).run(["$templateCache", function($templateCache) {
    $templateCache.put("view/calendar1/week.html",
        "<div>\n" +
